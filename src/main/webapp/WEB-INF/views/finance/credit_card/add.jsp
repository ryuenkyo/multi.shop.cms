                    ...
                    <div class="span12 form-dark">
                        <fieldset>
                            <ul class="form-list label-left list-bordered dotted">
                                ...
                                <li class="control-group">
                                    <label for="bank" class="control-label">发卡行<span class="required">*</span></label>
                                    <div class="controls">
                                ...
                                <li class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="billday" type="text" name="billday" value="">
                                    </div>
                                </li>
                                <li class="control-group">
                                    <label for="repaymentday" class="control-label">还款日期 <span class="required">*</span></label>
                                    <div class="controls">
                                        <input id="repaymentday" class="span11" type="text" name="repaymentday" value="">
                                    </div>
                                </li>
