                                        ...
                                        <ul class="form-list label-left list-bordered dotted">
                                            ...
                                            <li class="control-group">
	                                            ...
	                                            <div class="controls">	                       
	                                                ...
	                                                <c:if test="${uploadType =='header'}"><input type="file" name="fileName"></c:if>  
	                                               	<img src="${form.logo}" class="thumbnail" width="256" height="96">
	                                               	<c:if test="${uploadType =='logo'}"><input type="file" name="fileName"></c:if>  
													<img src="${form.footerImg}" class="thumbnail" width="256" height="96">
	                                            	<c:if test="${uploadType =='footer'}"><input type="file" name="fileName"></c:if>    	                                                
	                                            </div>
	                                        </li>
                                        </ul>
                                    </fieldset>        
