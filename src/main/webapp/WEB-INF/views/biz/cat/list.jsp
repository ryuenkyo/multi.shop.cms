...
<table id="exampleDTA" class="table boo-table table-striped table-hover">
    <thead>
        <tr>
            ...
            <th scope="col">分类商品 <span class="column-sorter"></span></th>
    ...
    <tbody>
       <c:forEach items="${resLst.content}" var="obj" varStatus="status">
            <tr>
                ...
                <td><a href="${appPath}/biz/cat/parent.do?parentId=${obj.id}">子分类<a></td>
                <td>${obj.status.title}</td>
                <td><a href="${appPath}/shop/product/list.do?catId=${obj.id}">设置<a></td>
                <td><a href="${appPath}/biz/cat/edit.do?id=${obj.id}">修改<a>
                </td>
            </tr>
        </c:forEach>
    </tbody>
