...
<!-- // page head -->
<link rel="stylesheet" type="text/css" href="${appCssPath}/assets/plugins/nivoSlider/nivo-slider.css" />
<style type="text/css">
#slider{margin:40px auto;background:url(${appCssPath}/assets/plugins/nivoSlider/images/loading.gif) no-repeat 50% 50%;}
...
<script type="text/javascript" src="${appCssPath}/assets/plugins/nivoSlider/jquery.nivo.slider.pack.js"></script>
                                ...
                                <div class="span12 form-dark">
                                    <fieldset>
                                        <ul class="form-list label-left list-bordered dotted">
                                            ...
                                            <li id="slider" class="nivoSlider control-group">
                                            	<c:forEach items="${bannerProducts.products}" var="obj" varStatus="status">
	                                                 <a href="${appPath}/shop/product/edit.do?id=${form.id}"><img width="100%" height="200" src="${form.logo}" alt="" title="${form.name}"/></a>
												</c:forEach>                                             
                                            </li>
                                            <li class="control-group">
                                            	<label for="accountWebsite_id" class="control-label">口号广告</label>
	                                            <img width="256" height="128" src="${slogan.logo}" alt="" title=""/>
	                                        </li> 
	                                         <li class="control-group">
	                                         	<label for="accountWebsite_id" class="control-label">广告图</label>
	                                            <img width="256" height="128" src="${topProduct.product.logo}" alt="" title="${topProduct.name}"/>
	                                        </li> 
                                        </ul>
                                    </fieldset>                                    
                                    <!-- // fieldset Input -->
