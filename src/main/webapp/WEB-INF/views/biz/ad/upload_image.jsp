...
<div id="TabTop1" class="tab-pane padding-bottom30 active fade in">
    <div class="row-fluid">
        <div class="span8 grider">
            ...
            <!-- // Widget -->            
             <section>
                <div class="well well-nice no-padding-bottom">
                    <ul class="thumbnails thumbnails-inline no-margin-bootom" id="imglist">
                     <c:forEach items="${uploadFileLst}" var="image" varStatus="status">
                        <li class="thumbnail">
                           <div class="equalize"><img width="96" height="96" src="${image.httpUrl}">
	                        	<p class="action"> 
	                        	 	<a class="btn btn-red" href="${appPath}/shop/product/del_imgage.do?id=${image.id}">刪除</a>
	                        	</p>
	                        </div>
