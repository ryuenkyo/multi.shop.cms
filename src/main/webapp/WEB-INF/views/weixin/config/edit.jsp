                    ...
                    <div class="span12 form-dark">
                        <fieldset>
                            <ul class="form-list label-left list-bordered dotted">
                                ...
                                <li class="control-group">
                                 ...
                                 <li class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <img src="${form.popularize}" class="thumbnail" width="96" height="96">
                                    </div>                                               
                                </li>
                                <li class="control-group">
                                ...
                                <li class="control-group">
                                    <label for="serverUrl" class="control-label">URL(服务器地址)<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" value="${form.serverUrl}" name="serverUrl" id="serverUrl">
                                    </div>
                                </li>
                                <li class="control-group">
