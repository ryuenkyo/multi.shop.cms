            ...
            <div class="widget widget-simple">              
                <div class="widget-content">
                    <div class="widget-body">
                         <form id="accounForm" class="form-horizontal" action="${appPath}/shop/product/upload_img.do?id=${form.id}&uploadType=${uploadType}"  method="POST" enctype="multipart/form-data" 
                                 ...
                                 <fieldset>
                                        <ul class="form-list label-left list-bordered dotted">
                                            <li class="section-form">
	                                         ...
	                                         <li class="control-group">
	                                            ...
	                                            <div class="controls">	                                           
	                                                <a href="${appPath}/shop/product/edit_logo_img.do?id=${form.id}"><img src="${form.logo}" class="thumbnail" width="96" height="96"></a>
                                    ...
                                    <fieldset>
                                        <ul class="form-list label-left list-bordered dotted">
                                            ...
                                            <li class="control-group">
                                                <label for="accountFirstName" class="control-label">分类 <span class="required">*</span></label>
                                                <div class="controls">
                                                	<input type="text" value="${form.category.name}" >                                                   
                                                </div>
                                            </li>
                                             <li class="control-group">
                                            ...
                                            <li class="control-group">
	                                            ...
	                                            <div class="controls">
	                                            	<textarea class="input-block-level" rows="4">${form.introduce}</textarea>                                                	
	                                            </div>
	                                        </li>
                                            <!-- // form item -->
