		  	...
		  	<div class="navbar">
	            <div class="navbar-inner no-bg">
	                <h4 class="title"><i class="fontello-icon-window"></i> 菜单 <small>
	                	<a href="${appPath}/admin/role_menu/list.do?menuId=${menu.id}" class="btn btn-blue">${user.username}</a>
	                </small></h4>
	            </div>
	        </div>
	        <!-- // navbar -->
		  	...
		  	<div class="navbar">
	            <div class="navbar-inner no-bg">
	                <h4 class="title"><i class="fontello-icon-window"></i> 角色 <small>
	                	<a href="${appPath}/admin/role_menu/list.do?roleId=${role.id}" class="btn btn-blue">${role.name}</a>
	                	</small></h4>
	            </div>
	        </div>
	        <!-- // navbar -->
