                                ...
                                <div class="span12 form-dark">
                                    <fieldset>
                                        <ul class="form-list label-left list-bordered dotted">
                                            ...
                                            <li class="control-group">
                                                <label for="brand" class="control-label">商品信息<span class="required">*</span></label>
                                                <div class="controls">
                                                    <a class="btn btn-green btn-small btn-glyph" href="${appPath}/shop/product/brand.do?id=${form.id}">品牌</a>
                                                    <a class="btn btn-green btn-small btn-glyph" href="${appPath}/shop/product/origin.do?id=${form.id}">产地</a>
                                                </div>                                               
                                            </li>
                                            <li class="control-group">
                                             ...
                                             <li class="control-group">
	                                              <label for="tags" class="control-label">标签<span class="required">*</span></label>
	                                              <div class="controls">
	                                                    <label class="checkbox inline">
					                                       	<input id="postfree" class="checkbox" type="checkbox" name="postfree" value="0">包邮
					                                    </label>
					                                    <label class="checkbox inline">
					                                       	<input id="groupPurchase" class="checkbox" type="checkbox" name="groupPurchase" value="option4">团购
					                                    </label>
	                                               </div>                                                  
                                            </li>                                        
                                            <li class="control-group">
	                                             <label for="count" class="control-label">商品数量<span class="required">*</span></label>
	                                             <div class="controls">
                                                    <input id="count" type="text" value="" name="count">
                                                </div>                                               
                                            </li>  
