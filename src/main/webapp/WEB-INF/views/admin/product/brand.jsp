                                ...
                                <div class="span12 form-dark">
                                    <fieldset>
                                        <ul class="form-list label-left list-bordered dotted">
                                            ...
                                            <li class="control-group">
                                                <label for="name" class="control-label">品牌选择<span class="required">*</span></label>
                                                <div class="controls">
                                                     <select id="brandSelect" class="selectpicker input-medium" data-style="btn-info" name="parentCatId" onchange="childCatChange()">
                                                        <c:forEach items="${brands}" var="brand" varStatus="brandStatus">
                                                        	<option value="${brand.id}">${brand.name}</option>
                                                        </c:forEach>
                                                    </select>
                                                    <a class="btn btn-green btn-small btn-glyph" href="${appPath}/shop/product/brand.do?id=${form.id}">品牌管理</a>
                                                </div>                                               
                                            </li>
                                            <li class="control-group">
                                                <label for="brand" class="control-label">品牌名称<span class="required">*</span></label>
                                                <div class="controls">
                                                    <input id="brand" type="text" value="${form.brand}" name="brand">
                                                    <a class="btn btn-green btn-small btn-glyph" href="${appPath}/shop/product/brand.do?id=${form.id}">修改</a>
                                                </div>                                               
                                            </li>
