...
<div class="center">
		...
		<div class="main-wrap">
			<div class="wrap-left">
				<div class="wrap-list">
					<div class="m-user">
						...
						<div class="m-userinfo">
							...
							<div class="m-baseinfo">
								...
								<div class="m-info">
									...
									<div class="m-address">
										<a href="${appPath}/information.do" class="i-trigger">个人地址<i class="am-icon-angle-right" style="padding-left:5px ;"></i></a>
									</div>
								</div>
							</div>
							<div class="m-right">
								<div class="m-new">
									<a href="news.html"><i class="am-icon-dropbox  am-icon-md" style="padding-right:5px ;"></i>发文章</a>
								</div>
						...
						<div class="wallet">
							...
							<p class="m-big squareS">
								<a href="#">
									<i><img src="${siteTempletDir}/images/shopping.png"/></i>
									<span class="m-title">能购物</span>
								</a>
							</p>
							<p class="m-big squareA">
								<a href="#">
									<i><img src="${siteTempletDir}/images/safe.png"/></i>
									<span class="m-title">够安全</span>
								</a>
							</p>
							<p class="m-big squareL">
								<a href="#">
									<i><img src="${siteTempletDir}/images/profit.png"/></i>
					...
					<div class="m-order">
						<div class="s-bar">
							<i class="s-icon"></i>我的收藏
							<a class="i-load-more-item-shadow" href="order.html">全部</a>
						</div>
						<ul>
							<li><a href="order.html"><i><img src="${siteTempletDir}/images/pay.png"/></i><span>收藏的个人</span></a></li>
							<li><a href="order.html"><i><img src="${siteTempletDir}/images/send.png"/></i><span>收藏宗亲会<em class="m-num">1</em></span></a></li>
							<li><a href="order.html"><i><img src="${siteTempletDir}/images/receive.png"/></i><span>收藏微信群</span></a></li>
							<li><a href="order.html"><i><img src="${siteTempletDir}/images/comment.png"/></i><span>收藏微信群<em class="m-num">3</em></span></a></li>
							<li><a href="change.html"><i><img src="${siteTempletDir}/images/refund.png"/></i><span>收藏微信群</span></a></li>
						</ul>
						<div class="orderContentBox">
							<div class="orderContent">
								<div class="orderContentpic">
									<div class="imgBox">
										<a href="orderinfo.html"><img src="${siteTempletDir}/images/youzi.jpg"></a>
									</div>
								</div>
						...
						<div class="orderContentBox">
							<div class="orderContent">
								<div class="orderContentpic">
									<div class="imgBox">
										<a href="orderinfo.html"><img src="${siteTempletDir}/images/heart.jpg"></a>
									</div>
								</div>
								<div class="detailContent">
						...
						<div class="twoTabModel credit">
							...
							<div class="Box">
								...
								<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
									<ul class="am-slides">
										<li><a href="#"><img src="${siteTempletDir}/images/333.jpg" /></a></li>
										<li><a href="#"><img src="${siteTempletDir}/images/222.jpg" /></a></li>
										<li><a href="#"><img src="${siteTempletDir}/images/111.jpg" /></a></li>
										<li><a href="#"><img src="${siteTempletDir}/images/333.jpg" /></a></li>
										<li><a href="#"><img src="${siteTempletDir}/images/222.jpg" /></a></li>
										<li><a href="#"><img src="${siteTempletDir}/images/111.jpg" /></a></li>
									</ul>
					...
					<div class="new-goods-info">
						<a class="shop-info" href="#">
							<div class="face-img-panel">
								<img src="${siteTempletDir}/images/imgsearch1.jpg" alt="">
							</div>
				...
				<div class="new-goods">
					...
					<div class="new-goods-info">
						<a class="shop-info" href="#" target="_blank">
							<div >
								<img src="${siteTempletDir}/images/666.jpg" alt="">
							</div>
                ...
                <div class="am-tabs-bd">
                    ...
                    <div data-tab-panel-0 class="am-tab-panel am-active">
                		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
							<ul class="am-slides">
                               <li>
                               	  <a><img class="am-thumbnail" src="${siteTempletDir}/images/EZA27501.jpg" /></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img class="am-thumbnail" src="${siteTempletDir}/images/BxJk6.jpg" /></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img class="am-thumbnail" src="${siteTempletDir}/images/Hxcag60.jpg" /></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img class="am-thumbnail" src="${siteTempletDir}/images/youzi.jpg" /></a>
                               	  <strong class="price">¥32.9</strong>
                               </li>
                               <li>
                               	  <a><img class="am-thumbnail" src="${siteTempletDir}/images/EZA27501.jpg" /></a>
	...
	<aside class="menu">
		<ul>
			...
			<li class="person">
				<p><i class="am-icon-balance-scale"></i>我的文章</p>
				<ul>
					<li><a href="order.html">文章列表</a></li>
