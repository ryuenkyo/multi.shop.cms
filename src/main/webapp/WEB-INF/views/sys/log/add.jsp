                                    ...
                                    <fieldset>
                                        <ul class="form-list label-left list-bordered dotted">
                                            ...
                                            <li class="control-group">
                                                <label for="accountPrefix" class="control-label">菜单编码<span class="required">*</span></label>
                                                <div class="controls">
                                                    <input id="accountPrefix" type="text" value="" name="accountPrefix">
                                                </div>                                               
                                            </li>
                                            <li class="control-group">
	                                            <label for="accountFirstName" class="control-label">菜单名称<span class="required">*</span></label>
	                                            <div class="controls">
