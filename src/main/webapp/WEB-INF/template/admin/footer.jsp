...
<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        <ul class="nav pull-left">
            ...
            <li class="divider-vertical"></li>
            <li><a class="fontello-icon-home-3" href="${appPath}/admin"></a></li>
            <li class="divider-vertical"></li>
        </ul>
        <ul class="nav pull-right">
            ...
            <li class="divider-vertical"></li>
            <li><a class="btn-glyph fontello-icon-cog-4 tip" href="${appPath}/admin/set.do" title="settings app"></a></li>
            <li class="divider-vertical"></li>
            <li><a id="btnLogout" class="btn-glyph fontello-icon-logout-1 tip" href="${appPath}/logout.do" title="setting"></a></li>
            <li class="divider-vertical"></li>
